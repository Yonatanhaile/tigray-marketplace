...
export const SUBCATEGORY_ICONS = {
  ...
  'Vehicle Services (Repair, Maintenance, Wash)': '🛠️',
  'Tires & Wheels': '⚙️',
  ...
  // Electronics
  'Laptops & Computers': '💻',
  'Computer Accessories (Mouse, Keyboard, Webcam)': '⌨️',
  'TVs & Home Theater': '📺',
  ...
  'Living Room Furniture (Sofas, Tables, Chairs)': '🛋️',
  'Bedroom Furniture (Beds, Wardrobes, Dressers)': '🛏️',
  'Kitchen Furniture & Equipment': '🍽️',
  'Office Furniture': '🪑',
  'Home Appliances (Refrigerators, Washing Machines)': '🔌',
  'Kitchen Appliances (Stoves, Microwaves, Blenders)': '🍳',
  'Home Decor & Accessories': '🖼️',
  'Garden & Outdoor': '🌿',
  'Lighting & Fans': '💡',
  'Mattresses & Bedding': '🛏️',
  ...
  // Repair & Construction
  'Construction Services (Building, Renovation)': '🏗️',
  'Electrical Services': '⚡',
  'Plumbing Services': '🚰',
  'Carpentry & Woodwork': '🪚',
  'Painting & Decoration': '🎨',
  ...
  'Factory & Industrial Equipment': '⚙️',
  'Printing & Publishing Equipment': '🖨️',
  'Medical Equipment': '🏥',
  ...
  // Babies & Kids
  'Baby Clothing': '👶',
  'Baby Furniture (Cribs, High Chairs)': '🛏️',
  'Strollers & Car Seats': '🍼',
